...
export const translations: Record<Language, Translations> = {
  'pt-BR': {
    ...
    hero: {
      ...
      eyebrow: '27 — 31 DEZ 2026 · ILHA DE BOIPEBA - BA',
      titlePart1: 'ALMA SALGADA',
      titlePart2: 'ALMA LAVADA',
      subtitle: [
        '1 ano de espera',
    ...
    manifesto: {
      kicker: 'O ALMA RÉVEILLON CONVIDA',
      h2Part1: 'Aqui o luxo',
      h2Part2: 'é outro.',
      lead: 'Boipeba é uma área de proteção ambiental (APA), reserva da biosfera e patrimônio da humanidade pela UNESCO. Uma ilha paradisíaca na Bahia, onde os carros ficam para trás e chegar é só o começo de uma aventura inesquecível.',
      p2: 'Aqueles que buscam novos ares e um destino pé na areia celebram a época mais charmosa do ano com uma vibe intimista e atmosfera hippie chic única no Brasil. Onde não entram carros nem salto alto, e o meio de transporte são jardineiras, quadriciclos e nossos pés.',
    },
    cinema: {
    ...
    lineup: {
      ...
      h2Part1: 'Cinco noites para',
      h2Part2: 'lavar a ALMA.',
      nights: [
        {
          date: '27/12 ~ 23h às 06h',
          title: 'Roda de Praia com +5521',
          subtitle: 'Resenha nova, os crias e muito digui digui diguiê nas areias da Cueira',
        },
        {
          date: '28/12 ~ 23h às 06h',
          title: '✖️ Isso Não É Um Sunrise by @IssoNaoeUmaFesta',
          subtitle: 'Uma nova festa e um novo amanhecer no paraíso',
        },
        {
          date: '29/12 ~ 23h às 06h',
          title: 'MOMO & Biribiri by @BailedoMomo Crew',
          subtitle: 'Súditos do MOMO, vocês estão prontos?',
        },
        {
          date: '30/12 ~ 23h às 06h',
          title: 'Luau do DDP',
          subtitle: 'O luau mais famoso do Brasil e a maior Open Vibe',
        },
        {
          date: '31/12 ~ 22h às 06h',
          title: 'A L M A Réveillon',
          subtitle: 'Corpo salgado e alma lavada',
        },
      ],
      sourceNote: 'Cinco noites temáticas e exclusivas de 27 a 31 de dezembro na Praia da Cueira. Open Bar Premium em todas as festas.',
    },
    openBar: {
  ...
  en: {
    ...
    lineup: {
      ...
      h2Part1: 'Five nights to',
      h2Part2: 'wash the SOUL.',
      nights: [
        {
          date: '27/12 ~ 11 PM to 6 AM',
          title: 'Roda de Praia com +5521',
          subtitle: 'New vibes, the crew, and pure energy on Cueira sands',
        },
        {
          date: '28/12 ~ 11 PM to 6 AM',
          title: '✖️ Isso Não É Um Sunrise by @IssoNaoeUmaFesta',
          subtitle: 'A new party and a new dawn in paradise',
        },
        {
          date: '29/12 ~ 11 PM to 6 AM',
          title: 'MOMO & Biribiri by @BailedoMomo Crew',
          subtitle: 'MOMO subjects, are you ready?',
        },
        {
          date: '30/12 ~ 11 PM to 6 AM',
          title: 'Luau do DDP',
          subtitle: 'Brazil’s most famous luau and highest Open Vibe',
        },
        {
          date: '31/12 ~ 10 PM to 6 AM',
          title: 'A L M A Réveillon',
          subtitle: 'Salty body and washed soul',
        },
      ],
      sourceNote: 'Five exclusive themed nights from December 27 to 31 at Praia da Cueira. Premium Open Bar at all parties.',
    },
    openBar: {
  ...
  es: {
    ...
    lineup: {
      ...
      h2Part1: 'Cinco noches para',
      h2Part2: 'lavar el ALMA.',
      nights: [
        {
          date: '27/12 ~ 23h a 06h',
          title: 'Roda de Praia com +5521',
          subtitle: 'Nueva vibra, la banda y pura energía en las arenas de Cueira',
        },
        {
          date: '28/12 ~ 23h a 06h',
          title: '✖️ Isso Não É Um Sunrise by @IssoNaoeUmaFesta',
          subtitle: 'Una nueva fiesta y un nuevo amanecer en el paraíso',
        },
        {
          date: '29/12 ~ 23h a 06h',
          title: 'MOMO & Biribiri by @BailedoMomo Crew',
          subtitle: 'Súbditos de MOMO, ¿están listos?',
        },
        {
          date: '30/12 ~ 23h a 06h',
          title: 'Luau do DDP',
          subtitle: 'El luau más famoso de Brasil y la mayor Open Vibe',
        },
        {
          date: '31/12 ~ 22h a 06h',
          title: 'A L M A Réveillon',
          subtitle: 'Cuerpo salado y alma lavada',
        },
      ],
      sourceNote: 'Cinco noches temáticas y exclusivas del 27 al 31 de diciembre en Praia da Cueira. Open Bar Premium en todas las fiestas.',
    },
    openBar: {
