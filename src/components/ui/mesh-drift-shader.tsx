...
interface MeshDriftShaderProps {
  className?: string
}

export default function MeshDriftShader({ className = '' }: MeshDriftShaderProps) {
  ...
  useEffect(() => {
    ...
    gl.uniform4f(uFinish, 0.00, 0.15, 0.007, 0.10)
    gl.uniform4f(uTransform, 5069.0, 2.72, 0.15, 0.0)
    gl.uniform4f(uSpace, 0.09, 0.15, 0.0, 0.0)
